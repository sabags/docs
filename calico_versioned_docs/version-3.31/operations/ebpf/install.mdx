...
import EbpfValue from '@site/calico_versioned_docs/version-3.31/_includes/content/_ebpf-value.mdx';

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

This guide shows you how to manually enable the eBPF data plane while installing $[prodname].
...
Calico uses eBPF mode by default on OpenShift. For more information on how to install Calico on OpenShift, see [Install an OpenShift 4 cluster with Calico](../../getting-started/kubernetes/openshift/installation.mdx).
