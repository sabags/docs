...
import EbpfValue from '@site/calico-enterprise_versioned_docs/version-3.23-1/_includes/content/_ebpf-value.mdx';
...
- [Configure $[prodname] to talk directly to the API server](#configure-calico-enterprise-to-talk-directly-to-the-api-server)
